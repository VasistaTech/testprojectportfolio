        ...
        const url = 'https://github.com/VasistaTech/testprojectportfolio/blob/main/public/suprith_m_resume_cv.pdf?raw=true'; // The relative path to your PDF in the web directory

        final anchor = html.AnchorElement(href: url)

        ..setAttribute('download', 'suprith_m_resume_cv.pdf') // Name of the downloaded file
